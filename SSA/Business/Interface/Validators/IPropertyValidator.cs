...
namespace Business.Interface.Validators
{
    public interface IPropertyValidator
    {
        ...
        Task<List<ValidationModel>> ValidatePropertyAttributeAsync(string loggedInUser, PropertyAttributeModel model);
        Task<List<ValidationModel>> ValidatePropertyListingAsync(string loggedInUser, PropertyListingModel model);
        Task<List<ValidationModel>> ValidatePropertyListingAttributeAsync(string loggedInUser, PropertyListingAttributeModel model);
