...
namespace DataAccess.Migrations
{
    ...
    [Migration("20221228105516_Corrected-Tenant-schema-column-name-typo")]
    partial class CorrectedTenantschemacolumnnametypo
    {
            ...
            modelBuilder.Entity("DataAccess.Entities.TenantPreference", b =>
                {
                    ...
                    b.Property<int?>("PreferedTenancyPeriod")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccess.Entities.PropertyListingAttribute", b =>
                {
                    ...
                    b.HasOne("DataAccess.Entities.TenancyType", "TenantType")
                        .WithOne()
                        .HasForeignKey("DataAccess.Entities.PropertyListingAttribute", "TenantTypeUID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
