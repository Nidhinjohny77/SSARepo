        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserUID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CountryUID = table.Column<int>(type: "int", nullable: false),
                    TenantTypeUID = table.Column<int>(type: "int", nullable: false),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferedTenancyPeriod = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PropertyAttribute_FurnishType_FurnishTypeUID",
                        column: x => x.FurnishTypeUID,
                        principalTable: "FurnishType",
                        principalColumn: "UID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurrentTenantItem", x => x.UID);
                    table.ForeignKey(
                        name: "FK_CurrentTenantItem_Currency_CurrencyUID",
                        column: x => x.CurrencyUID,
                        principalTable: "Currency",
                        principalColumn: "UID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CurrentTenantItem_Item_ItemUID",
                        column: x => x.ItemUID,
                        principalTable: "Item",
                        principalColumn: "UID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CurrentTenantItem_PropertyRenting_PropertyRentingUID",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Tees Valley,Middlesbrough,England", "tees.uni@gmail.com", "7464647464", 1, true, "Teeside University", 3, "UNITEES" });

            migrationBuilder.InsertData(
                table: "University",
                columns: new[] { "UID", "Address", "ContactEmail", "ContactNumber", "CountryUID", "IsActive", "Name", "Ratings", "UniversityCode" },
                values: new object[] { 2, "Ediburgh,Scotland", "universityofedinburgh.uni@gmail.com", "7334647464", 1, true, "University of Edinburgh", 5, "UNIEDIN" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CurrentTenantItem_CurrencyUID",
                table: "CurrentTenantItem",
                column: "CurrencyUID",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CurrentTenantItem_ItemUID",
                table: "CurrentTenantItem",
                column: "ItemUID",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CurrentTenantItem_PropertyRentingUID",
                table: "CurrentTenantItem",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyAttribute_FurnishTypeUID",
