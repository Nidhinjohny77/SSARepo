...
namespace DataAccess.Migrations
{
    ...
    [Migration("20221230112619_schema-change-v3.0")]
    partial class schemachangev30
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Entities.ImageFileType", b =>
                {
                    b.Property<int>("UID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ImageFileType", (string)null);
            ...
            modelBuilder.Entity("DataAccess.Entities.PropertyImage", b =>
                {
                    ...
                    b.Property<int>("ImageFileTypeUID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccess.Entities.PropertyImage", b =>
                {
                    b.HasOne("DataAccess.Entities.ImageFileType", "ImageFileType")
                        .WithMany()
                        .HasForeignKey("ImageFileTypeUID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
